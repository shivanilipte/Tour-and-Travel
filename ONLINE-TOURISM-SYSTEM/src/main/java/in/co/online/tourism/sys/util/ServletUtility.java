...
import in.co.online.tourism.sys.controller.BaseCtl;
import in.co.online.tourism.sys.controller.OTSView;
...
public class ServletUtility {
	...
	public static void handleException(Exception e, HttpServletRequest request, HttpServletResponse response)
		...
		ServletUtility.forward(OTSView.ERROR_CTL, request, response);
		e.printStackTrace();
	}
