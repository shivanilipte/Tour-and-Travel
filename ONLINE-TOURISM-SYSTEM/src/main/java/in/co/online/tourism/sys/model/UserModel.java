...
import in.co.online.tourism.sys.exception.RecordNotFoundException;
import in.co.online.tourism.sys.util.EmailBuilder;
import in.co.online.tourism.sys.util.EmailMessage;
import in.co.online.tourism.sys.util.EmailUtility;
...
public class UserModel {
	...
	public long getOTSID() {
		...
		OTS_ID = (int) (Math.random() * max + min);
	...
	public void update(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE T_USER SET FIRST_NAME=?,LAST_NAME=?,LOGIN=?,PASSWORD=?,EMAIL_ID=?,OTS_ID=?,MOBILE_NO=?,"
							+ "GENDER=?,DOB=?,ROLE_ID=?,"
	...
	public boolean changePassword(Long id, String oldPassword, String newPassword)
		...
		msg.setSubject("Online Tourism System Password has been changed Successfully.");
