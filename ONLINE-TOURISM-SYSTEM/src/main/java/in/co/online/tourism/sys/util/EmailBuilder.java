package in.co.online.tourism.sys.util;
...
public class EmailBuilder {
	...
	public static String getUserRegistrationMessage(HashMap<String, String> map) {
		...
		msg.append("Registration is successful for Online Tourism System");
		msg.append("<H1>Hi! Greetings from Online Tourism System!</H1>");
		msg.append(
				"<P>Congratulations for registering on Online Tourism System You can now access your OTS account online - anywhere, anytime and  enjoy the flexibility to check the Tourism Details.</P>");
