...
<form style="width: 60%;margin-top: 25px" action="<%=OTSView.USER_REGISTRATION_CTL%>" method="post">
...
<input type="hidden" name="id" value="<%=bean.getId()%>"> <input
  ...
  <div class="form-row">
    ...
    <input type="submit" name="operation" class="btn btn-primary"
					value="<%=UserRegistrationCtl.OP_SIGN_UP%>"> or <input type="submit" name="operation" class="btn btn-primary"
